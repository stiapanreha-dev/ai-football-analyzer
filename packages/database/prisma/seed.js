...
const archetypes = [
    {
        ...
        behaviorExample: 'В этой ситуации Лидер взял бы на себя инициативу, собрал команду и чётко сказал, что делать дальше.',
        orderNum: 1,
    },
    {
        code: 'warrior',
        ...
        behaviorExample: 'Воин бы усилил давление, пошёл в жёсткую борьбу и зарядил команду своей энергией.',
        orderNum: 2,
    },
    {
        code: 'strategist',
        ...
        behaviorExample: 'Стратег бы остановился, оценил ситуацию, нашёл слабое место соперника и предложил план.',
        orderNum: 3,
    },
    {
        code: 'diplomat',
        ...
        behaviorExample: 'Дипломат бы успокоил эмоции в команде, нашёл компромисс и восстановил рабочую атмосферу.',
        orderNum: 4,
    },
    {
        code: 'executor',
        ...
        behaviorExample: 'Исполнитель бы чётко выполнил указания тренера, сосредоточившись на своей зоне ответственности.',
        orderNum: 5,
    },
    {
        code: 'individualist',
    ...
    },
    {
        ...
        behaviorExample: 'Избегающий бы отдал мяч партнёру, ушёл от принятия решения, переложил ответственность.',
        orderNum: 7,
    },
];
